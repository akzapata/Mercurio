...
public class MercurioPageO  extends PageObject {
	...
	@FindBy(xpath="//img[@src='http://tapp.eafit.edu.co/imagenes/v1/botones/btn_guardar.gif']")
	...
	public void ingresodatosform(String nom, String ape, String gen) throws InterruptedException {
